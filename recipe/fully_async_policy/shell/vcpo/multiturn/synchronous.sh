...
# ================= Logging =================
exp_name="Synchronous DAPO-AIME Qwen2.5-7B ${n_gpus_rollout}-${n_gpus_training} B-${train_prompt_mini_bsz} ${loss_agg_mode} ${max_response_length}-len ${weight_decay}-wd ${bsz_per_dp_rank}-rollout_bsz"
