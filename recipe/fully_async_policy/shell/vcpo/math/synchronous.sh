...
# Set true to log per-trajectory gradient statistics
...
# ================= Logging =================
exp_name="Synchronous MATH Qwen2.5-7B B-${train_prompt_mini_bsz} ${loss_agg_mode} ${max_response_length}-len ${weight_decay}-wd"
